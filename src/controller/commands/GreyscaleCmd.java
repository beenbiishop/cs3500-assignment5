 ...
 * {@code ImageProcessorCmd} interface and execute the command. Greyscales the image.
 */
public class GreyscaleCmd implements ImageProcessorCmd {
   ...
   */
  public GreyscaleCmd(ImageProcessorView view, StoredImages store, String fileName, String newFileName)
  ...
  public void execute() {
    ...
    this.view.renderMessage(
            "Greyscaled \"" + this.fileName + "\" and saved as \"" + this.newFileName + "\""
