...
/**
 * Class that represents a command, "Greyscale", that the processor can handle. Implements the
 * {@code ImageProcessorCmd} interface and execute the command. Filters the image to greyscale.
 */
public class GreyscaleCmd implements ImageProcessorCmd {
   ...
   */
  public GreyscaleCmd(ImageProcessorView view, StoredImages store, String fileName,
  ...
  public void execute() {
    ...
    this.view.renderMessage(
        "Applied greyscale to \"" + this.fileName + "\" and saved as \"" + this.newFileName + "\""
